...
export default function Orders() {
  ...
  const [form, setForm] = useState({ entregados_llenos: "", botellones_recolectados: "" });
  ...
  return (
    <div>
      ...
      <div className="form-card">
        ...
        <form onSubmit={createOrder}>
          ...
          <input
            ...
            onChange={(e) => setNewOrder({ ...newOrder, fardos: e.target.value })}
            required
          />
          ...
          <input
            ...
            onChange={(e) => setNewOrder({ ...newOrder, botellones_solicitados: e.target.value })}
          />
      ...
      {!loading && orders.length === 0 && <div className="muted">No hay pedidos todavía.</div>}
            ...
            <div style={{ display: "flex", justifyContent: "space-between" }}>
              ...
              <div style={{ textAlign: "right" }}>
                {order.estado === "pendiente" ? (
                  <button className="btn btn-primary" onClick={() => openDelivery(order)}>
                ...
                <button
                  ...
                  style={{ marginTop: 8 }}
                  onClick={() => {
                    api.delete(`/api/orders/${order.id}`).then(load);
                  }}
                >
                  <FiTrash2 />
                </button>
        ...
        <div className="modal-backdrop">
          <div className="modal">
            ...
            <input
              ...
              onChange={(e) => setForm({ ...form, entregados_llenos: e.target.value })}
            />
            ...
            <input
              ...
              onChange={(e) => setForm({ ...form, botellones_recolectados: e.target.value })}
            />
